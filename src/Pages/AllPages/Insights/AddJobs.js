...
//                         <p>Start typing user name, ID or email</p>
//                        <Select/>
//                     </div>
//                     <div>
//                         <ul>
//                             {acc.map(account => (
//                                 <li key={acc.id}>{account.Name}</li>
//                             ))}
//                         </ul>
//                     </div>
//                 </div>
...
import "./addjob.css"
import TextEditor from '../../../Components/Templates/Texteditor.js';
        ...
        <>
            ...
            <div className='add-jobs-container '>
                <div className='add-jobs-header' style={{ display: 'flex', justifyContent: 'space-between', margin: '10px' }}>
                    <h3>Add Job</h3>
                    <button className='btn1' style={{ backgroundColor: '#e4e9f7' }}>

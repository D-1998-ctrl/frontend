            ...
            <div className='job-template-form-area'>
              <div className='job-template-create-form col-6' >
                ...
                <div>
                  ...
                  <input style={{ padding: '8px 12px', width: '100%', border: "2px solid rgb(100, 149, 237)", borderRadius: '10px', margin: '10px 0' }} type='text' className='job-input'  value={jobname + selectedShortcut} onChange={(e) => setjobname(e.target.value)} placeholder='Job name' />
                </div>


                <div className='addshortcodes' style={{ color: 'var(--links-background)', cursor: 'pointer' }}>
                  <button onClick={toggleDropdown} className="add-shortcut-icon" style={{border:'none',background:'none',color:'blue'}}>   <RiAddCircleLine/>Add Shortcode 
                  </button>
